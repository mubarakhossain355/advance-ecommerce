            ...
            <div class="cart-list-head">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            <form action="{{route('update-cart-product',['id' => $cart_product->__raw_id])}}" method="POST">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="qty" value="{{$cart_product->qty}}" min="1" required>
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" onclick="return confirm('Are you sure remove this ?')" href="{{route('remove-cart-product',['id' => $cart_product->__raw_id])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
