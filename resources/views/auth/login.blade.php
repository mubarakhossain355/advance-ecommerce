...
<head>
    ...
    <title>Khilji Shop Admin - login </title>
            ...
            <div class="login-box card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material"  action="{{route('login')}}" method="POST">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="password" name="password" required="" placeholder="Enter Password"> </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex no-block align-items-center">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"  name="remember" for="customCheck1">Remember me</label>
                                    </div> 
                                    <div class="ms-auto">
