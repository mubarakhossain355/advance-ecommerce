                                ...
                                <div class="row">
                                        ...
                                        <div class="single-form form-default">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-input form">
                                                    ...
                                                    <input type="text" name="name" value="{{$customer->name}}" placeholder="Full Name" readonly>
                                                    @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            ...
                                            <div class="form-input form">
                                                @if(isset($customer->id))
                                                <input type="number" name="mobile" value="{{$customer->mobile}}" placeholder="Phone Number" readonly>
                                                @else
